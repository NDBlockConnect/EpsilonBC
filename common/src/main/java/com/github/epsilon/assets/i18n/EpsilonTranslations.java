...
public final class EpsilonTranslations {
    ...
    public static final class Gui {
        ...
        public static final TranslateComponent MAINMENU_HINATA_GREETING = create("gui", "mainmenu.hinata_greeting");
        public static final TranslateComponent MAINMENU_HINATA_FAREWELL = create("gui", "mainmenu.hinata_farewell");
